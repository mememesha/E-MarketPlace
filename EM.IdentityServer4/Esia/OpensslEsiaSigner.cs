...
namespace EM.IdentityServer4.Esia
{
    ...
    {
        // private const string KEY_FILE = @"/app/cert/esia.key";
        // private const string CRT_FILE = @"/app/cert/esia.pem";

        private const string KEY_FILE = @"/https/ekapusta.gost.test.key";
        private const string CRT_FILE = @"/https/ekapusta.gost.test.cer";
